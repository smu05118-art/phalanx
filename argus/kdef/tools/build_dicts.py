...
DOMAINS = [
    ...
    ("AIR", "공중", "Air systems", 3,
     ["KF-21", "KF-X", "KF21", "T-50", "FA-50", "TA-50", "KT-1", "KUH-1", "수리온", "LAH", "LCH",
      "MUH-1", "마린온", "P-3", "F-15K", "F-16", "F-35", "C-130", "KC-330", "MRO"],
     ["전투기", "훈련기", "헬기", "회전익", "고정익", "완제기", "무인기", "UAV", "무인항공기",
      "항공기", "기체구조물", "동체", "착륙장치", "항공엔진", "비행체"]),
    ("MISSILE", "유도무기", "Guided weapons", 4,
     ["천궁", "철매", "L-SAM", "LSAM", "M-SAM", "해궁", "해성", "현무", "신궁", "천검", "비궁",
      "천룡", "장공지", "천무", "군위성", "PGM"],
     ["유도탄", "유도무기", "미사일", "대공유도", "대함유도", "대지유도", "공대지", "공대공",
      "함대공", "지대공", "지대지", "다련장", "유도로켓", "탄도탄", "요격"]),
    ...
    ("CIVIL", "민수", "Civil", 0,
     ["에코플랜트", "ONCF", "B787", "A350", "A320", "B737"],
     ["철도차량", "전동차", "고속철", "트램", "경전철", "차량기지", "신호시스템", "플랜트",
      "제철설비", "자동차설비", "정수", "수소충전", "발전설비", "풍력", "아스팔트", "공작기계",
      "반도체장비", "민항", "여객기", "화물기", "상용차", "승용차", "버스", "굴착기"]),
]
...
CONTRACT_TYPES = [
    ...
    ("FOLLOW", "후속양산", "Follow-on production", r"후속\s*양산|\d+\s*차\s*양산|양산\s*\d+차|재양산|"
     r"추가\s*양산|양산", 2),
    ("SUPPLY", "물품구매·납품", "Supply", r"물품\s*구매|구매\s*계약|납품|공급\s*계약|판매\s*계약|"
     r"부품\s*공급|수출\s*실행계약", 5),
]
