...
CATS = [
    ...
    ("PROP.SHAFT", "축계·선미관·베어링", "Shafting", 70, True,
     ["축계", "프로펠러축", "중간축", "선미관", "스턴튜브", "축베어링", "커플링", "감속기어", "추진축", "감속기", "기어박스", "정밀기어", "동력전달장치"], ["승강기", "로봇", "산업용", "풍력"], ["R_SHAFT"]),
    ...
    ("ENG.FUEL", "연료공급(FGSS·LFSS)", "Fuel supply systems", 85, False,
     ["FGSS", "LFSS", "연료가스공급", "연료공급시스템", "고압펌프", "연료분사펌프", "벙커링", "연료공급장치", "LNG연료공급", "기화기", "고압연소식기화기", "LNG기화기", "연료가스"], [], ["Z_FUEL", "R_FUEL_TANK"]),
    ...
    ("DECK.WINCH", "윈치·윈드라스·계류", "Winches & mooring", 78, True,
     ["윈치", "무어링", "윈드라스", "앵커", "앵커체인", "체인", "캡스턴", "계선", "계류장치", "무어링윈치", "로프", "계류삭", "섬유로프", "와이어로프", "합섬로프", "합섬섬유로프"], ["교량용", "영구앵커", "엘리베이터", "승강기"], ["R_AFT_MOORING", "R_FORECASTLE"]),
    ...
    ("PIPE.PIPE", "배관·스풀·극저온배관", "Piping & spools", 68, True,
     ["배관", "선박용배관", "파이프스풀", "스풀", "이중배관", "극저온배관", "진공단열배관", "배관제작", "파이프", "배관자재", "강관"], ["교량용케이블"], ["R_DECK_PIPING"]),
    ...
    ("NAV.NAV", "항해·통신·스마트십", "Navigation & communications", 80, True,
     ["항해장비", "레이더", "ECDIS", "자이로", "오토파일럿", "항해통신", "AIS", "VDR", "위성통신", "선내통신", "스마트십", "자율운항", "브릿지시스템", "GMDSS", "위성안테나", "해상용위성", "전투체계", "전투지휘체계", "함정전투", "소나", "열영상감시", "탐지추적", "함정레이더"], [], ["R_BRIDGE"]),
