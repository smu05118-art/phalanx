...
CONTRACT_TYPES = [
    ...
    ("OM", "정비·O&M", "Maintenance / O&M", 6,
     ...
     r"위탁운전|운전위탁|운전\s*용역|운영\s*용역|Maintenance", None),
    ...
    ("MAIN", "주기기", "NSSS / main equipment", 1,
     ...
     r"증기터빈|가스터빈|터빈발전기|터빈\b|발전기\b|주단조|원자로냉각재|"
    ...
    ("AUX", "보조기기", "BOP / auxiliaries", 5,
     ...
     r"FGD\b|ESP\b|Desulfuri|Precipitator|Boiler\b", None),
