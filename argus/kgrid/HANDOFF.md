...
- 모집단 **40종목** — 업종 13 · 지정 15 · 제품 1 · **탐색 8**(본문 인용으로 승격) · 지주 3(집계 제외).
- 정기보고서 **40사 × 6분기, 실패 0**. 수주잔고를 공시하는 회사 **25사**.
- 배수 중앙값 **0.71년**, **장납기 9사 : 회전 13사** — 스펙의 이분 가설이 전수로 확인됐다.
- 외화로 잔고를 공시하는 회사 1사(일진전기 `천USD`) — 환산하지 않고 배수를 비웠다.
- 계약 공시 **자사 176건**(지주·모회사의 자회사 재공시 76건은 갈라 놓았다) · 발주처·지역 집계.
- 페이지 43장(허브·단선도·커버리지 + 회사 40). 테스트 **101건 통과**.
