...
- 분기말 당일이 주간 TGA 관측일이 아니면 직전 6일 이내의 가장
  가까운 관측만 시차와 함께 `PRIOR_WEEKLY_PROXY`로 표시한다.
- 외부 방출 근거는 분기말 기준일·관측일·공식 Treasury/Fed URL·
  원문 SHA-256가 모두 있고 해당 분기와 일치할 때만 인정한다.
